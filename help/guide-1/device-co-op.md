...
- [[!DNL Adobe Advertising]](https://experienceleague.adobe.com/docs/advertising.html?lang=nl-NL)
...
Met de beëindiging van de [!DNL Device Co-op] is de indicator [!UICONTROL People] niet langer relevant. Op 8 mei 2023 zullen we de indicator [!UICONTROL People] verwijderen. Op dat moment zullen we de gegevens omleiden naar de indicator [!UICONTROL Unique Visitor] in Analytics om te voorkomen dat projecten, segmenten en berekende statistieken beschadigd raken.
